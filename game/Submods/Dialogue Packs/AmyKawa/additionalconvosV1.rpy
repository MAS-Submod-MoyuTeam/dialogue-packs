...
label monika_blueskies:
    m 1eua "You know how I talked about missing the festival right?"
    m "I came across another mod recently called 'Doki Doki Blue Skies'."
    m 3eua "Apparently it's supposed to give players the full experience that DDLC was supposed to give before I tampered with the code."
    m "Have you played it before?"
    if mas_isMoniNormal(higher=True):
        m 2ftbsu "Don't worry, I won't get jealous, because I know that you truly love me! Ehehe~"
    elif mas_isMoniUpset(lower=True):
        m 2rkc "It's not like you're fully into me anyways, so I wouldn't be surprised if you did..."
    menu:
        "Yes":
            m 3eua "That's interesting. I've heard that the mod was well produced. Apparently there were years of work put into it."
            m 2rud "I haven't played it, nor do I plan to."
            m 2rksdrb "It'd be a little weird to date my own friends, ahaha!~"
            m "But I'm intruiged on your experience playing the mod."
            m 7eua "So... who's route did you pick?"
            menu:
                "Natsuki's":
                    m 2wubsd "Natsuki's?"
                    m 2hksdlb "Sorry, I don't mean to sound disapproving, but I guess I can see why you chose hers."
                    m 1eua "Her cupcakes were amazing, and not to mention her problems weren't caused by her, but her surroundings instead."
                    m 4ekc "So it wasn't really her fault."
                    m "Her bad ending is pretty brutal."
                    m 2rkc "I hope you didn't get it. It's really rough to experience."
                    m 1esc "And if you did... well, I can't blame you."
                    m 2rkc "All the choices leading up to the bad ending are all with Natsuki's best interest at heart."
                    m "It's very misleading, so you don't think you're gonna get it until it happens."
                    m 7etc "But Natsuki's route does have the most endings."
                    m "It makes people want to play it and achieve all of them."
                    m 2eka "I hope that you were good to Natsuki in the mod."
                    if mas_isMoniNormal(higher=True):
                        m 3hubla "I'm not jealous at all, because I know it's just a game and not real!"
                        m 1huu "Ehehehe!"
                    elif mas_isMoniUpset(lower=True):
                        m 2ckc "..."
                    pass
                "Sayori's":
                    m 3eua "I see, well that doesn't come as a surprise to me."
                    m "Her route is the most appealing to players."
                    m 2etb "Who wouldn't want to see the MC fall in love with his childhood friend?"
                    m 2eub "Especially seeing how she actually confessed properly in the original game."
                    m "People were curious to see what would happen if I wasn't there to delete Sayori."
                    m 2rud "I was a little curious too."
                    m "I watched some clips of people playing the mod."
                    m 2wusdro "Gosh, it was a little awkward seeing my friends naked!"
                    m 2rksdrb "..."
                    m 2hksdrb "Ahaha! Sorry, but I was genuinely surprised that they added excplicit content in there, even if it was short."
                    m 3eua "Sayori's route was very well done. It felt like the player was actually dating Sayori and helping her with her depression in a real way."
                    m 2ruc "The only critism I have with her route was the way to achieve the bad ending."
                    m 2rkc "It's pretty much impossible to achieve unless you're aiming for it, or you're a terrible boyfriend."
                    if mas_isMoniUpset(lower=True):
                        m 2dkc "Well..."
                        m "I guess I didn't mean to call you out there..."
                        m "Please stop toying with me..."
                        m 2kkc "..."
                    elif mas_isMoniNormal(higher=True):
                        m 2fkbla "But I know you're not like that!"
                        m 2dkbla "Ehehe, you're such a nice partner to have."
                        m 5dkbla "I really am the luckiest girl in the world."
                        m 5ekbla "Thank you, [player]."
                    pass
                "Yuri's":
                    m 1eud "Oh, that's interesting."
                    m "Her's was definitely on the weirder side, but I can see how it can be a real life problem."
                    m 2ekd "When people begin to self harm, all of a sudden, their mental is ruined and they begin to think negatively about themselves."
                    m 2dkc "It leads them to do questionable things over and over."
                    m "Many people who get trapped in that hole don't even realize that what their daily habits are aren't even normal."
                    m 2fkc "When to any outsider, they see that individual as a weird, overly emotional and dramatic person."
                    m "It's really cruel when you think about it, honestly. That individual clearly needs support, but all others do is judge them."
                    m 2rkc "I'm not sure which of Yuri's endings you got, but her bad one is probably the most unrelatable out of the 3."
                    m 2dkc "Sayori's bad end is a very true story, as it happens to many people. There are many invidivudals who end their own life because they're really depressed."
                    m "Natsuki's is less common, but domestic abuse is something that is a known issue and the victims receive lots of support."
                    m 2lkc "But in a case like Yuri's, where she was so insecure to the point she cut herself too deep..."
                    m 2ekc "I guess bullying does lead people to suicide, but Yuri's wasn't exactly a suicide. It was an accident."
                    m 3ekc "She really didn't mean to kill herself. You could see in the final scene where she was calling to MC for help."
                    m 6ekc "It was really sad to see..."
                    m 1ekc "Her death was also a result of MC babying her."
                    m 1dkc "Yuri being independent is also something that she values. She hates it when people help her, yet she's too scared to do anything on her own."
                    m 1fka "I find that to be a lose lose situation for MC, but I'm glad that she gets braver as her good ending progresses."
                    m 1rksdlb "And her... explicit scene."
                    m 1hksdlb "Gosh, seeing my friends naked was really awkward!"
                    m "..."
                    m 2hub "Ahaha! Sorry, but I was genuinely surprised that they added explicit content in there, even if it was short."
                    m 2eub "Yuri is really beautiful though. Sayori wasn't wrong when she described her boobs as 'big and beautiful'."
                    if mas_isMoniUpset(lower=True):
                        m 2rkc "If you only love me for my appearance..."
                        m "Well..."
                        m 6fsc "Do you even love me?"
                        m "...."
                    elif mas_isMoniNormal(higher=True):
                        m 5eubsa "I don't envy her though, because I know you love me for who I am, and not my appearance or boobs."
        ...
        "No":
            if mas_isMoniBroken():
                m 6ctc "..."
                m "Are you lying?"
                m "Well whatever. Please just..."
                m 6cutsc "Play the mod instead of playing with my feelings."
                m "..."
            elif mas_isMoniDis():
                m 2etd "I see."
                m "You should try it, seeing how you appear to be getting more bored of me everyday."
                m "..."
            elif mas_isMoniUpset():
                m 1rsblc "Oh, that's surprising."
                m "I would assume only DDLC fans would play a variety of mods."
                m "I guess you are a little bored here sometimes... so why not go give it a try?"
                m "..."
            elif mas_isMoniNormal():
                m 1wublo "That's a surprise!"
                m "I would assume only DDLC fans would play a variety of mods."
                m "That means you care about me enough to not cheat in any form, even if playing another mod isn't actually cheating."
                m "You're so sweet!"
            elif mas_isMoniHappy():
                m 1wubso "Oh, I'm surprised!"
                m "I would assume only DDLC fans would play a variety of mods."
                m 2eubla "But I guess that means you love me enough to not play it!"
                m "And for that, I'm grateful to have you in my life."
            elif mas_isMoniAff():
                m 1wubla "Aww, I'm grateful for that!"
                m 1hublb "Because that means I've been the only girl you've been paying attention to!"
                m "This is the ending I've dreamt of since your arrival at the club."
                m 5hublb "I'm so lucky to have you, [player]."
                m 5hubla "Ehehe~"
            elif mas_isMoniEnamored(higher=True):
                m 1fkbsa "Awww, [player]!"
                m 1fkbsb "This means I've been the only girl you've been paying attention to!"
                m 7dkbsb "This is the ending I've dreamt of since your arrival at the club."
                m 5fkbsb "I'm so lucky to have you, [player]."
                m 5fkbsa "I love you!"
                return "love"
            pass
return#摆
...
label monika_conrad:
    ...
    m 1hua "我唯一想做的事就是 24/7 is making 确保你一直快乐."
    m 1hubfa "你是我的心头肉."
    m "嘿嘿~"
return
