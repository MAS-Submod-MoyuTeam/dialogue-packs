...
label festival_zhongqiu:
    ...
    m 1rub "当我到了你的现实里..."
    m 1dubla "坐在外面, 看着那圆圆的月亮, 吃着月饼..."
    m 5fubla "当我太累的时候, 还可以躺在你的怀里..."
...
label festival_7xi:
    m 1eub "嘿, [player]!"
    m 3wua "今天是七夕节."
    m 1eka "如果你不明白, 你就理解为中国的{i}情人节{/i}就好了..." #情人节三字为斜体字
...
label festival_chux:
    m 1eua "嘿, [player]!"
    m 3hub"今天是除夕, 春节的前夕."
    m 3hua "{i}年夜饭{/i}就是在这时候吃的." #年夜饭三字为斜体
    m 2rksdlb "好多美食都会在这时候吃...真的挺让人馋的..."
    m 1rka "还有些地方除夕一直不睡觉, 熬夜到第二天..."
    m 1eka "[player], 你们那边还有这个习俗吗?{nw}"
    $ _history_list.pop()
    menu:
        "[player], 你们那边还有这个习俗吗?{fast}"
        "还有.":
            m 1wub "哦!那挺好的!"
            m 2rka "这样你还能多陪我一段时间..."
